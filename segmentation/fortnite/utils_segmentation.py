...
def augmentation_images(images,annotations,img_path,annot_path):
    """
    images = glob.glob('images_train_2/*.png')
    annotations = glob.glob('annotations_train_2/*.png')
    """
    
#     img_path = images[0].split('/')[:2]
#     annot_path = annotations[0].split('/')[:2]
...
def IOU_list_files_v2(test_data,model,img_folder='test_labeled_dataset/data/',
